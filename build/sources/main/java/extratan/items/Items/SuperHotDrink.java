...
public class SuperHotDrink extends BaseDrinkableItem {
	
	List<ItemStack> timedItems = new ArrayList<ItemStack>();
	Map<ItemStack,Timer> itemTimers = new HashMap<ItemStack,Timer>();

	public SuperHotDrink() {
		super("superHotDrink", "flask_with_super_hot_water", 8, ItemStorage.Empty_Flask, CreativeTabHandler.ExtraTANDrinks);
